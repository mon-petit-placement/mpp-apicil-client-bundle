...
class ApicilPartialRepurchaseClientOptionResolver
{
    ...
    public static function resolveGetEmailTemplateOptions(array $options): array
    {
        $resolver = (new OptionsResolver())
            ->setDefined('type')->setAllowedTypes('type', ['string'])->setAllowedValues('type', ['PONCTUEL', 'PROGRAMME', 'SUPPRESSION_PROGRAMME'])
